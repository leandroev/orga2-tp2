...
// creo archivo csv
    int tam_name = sizeof("AvengersEndGame");
    int tam_dim = sizeof("1200x1024");
    char buffer[50];
    snprintf(buffer, tam_dim, "%s", basename(config->archivo_entrada)+tam_name);
    
    char nameFiltro1[100] = "resultados/multi/";
    strcat(nameFiltro1,buffer);
    strcat(nameFiltro1,"_");
...
// creo archivo csv
    char nameFiltro2[100] = "resultados/multi/";
    strcat(nameFiltro2,buffer);
    strcat(nameFiltro2,"_");
