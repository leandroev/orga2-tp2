...
ImagenFantasma_x4_asm:
	...
	movq xmm0, [rdi+rbx] 		; xmm0: 127-bit |0000|0000|pixel1|pixel 0| 0-bit	=
							; xmm0: 127-bit |0|0|0|0|0|0|0|0|a1|r1|g1|b1|a0|r0|g0|b0| 0-bit 							
	punpcklbw xmm0, xmm15 	; xmm0: |a1|r1|g1|b1|a0|r0|g0|b0|
	movdqu xmm1, xmm0 		; xmm1 = xmm0
	punpcklwd xmm0, xmm15	; xmm0: |a0|r0|g0|b0|
	...
	movq [rsi+rbx], xmm0 		; *src <- xmm0 : pixel 1|pixel 0 de la fila siguiente	
	...
	.cambio_fila:
	add rdi, rbx	 		; avanzo una fila entera
	add rsi, rbx 			; avanzo una fila entera

	.sigo:
	add rdi, 8 				; avanzo 2 pixeles
	add rsi, 8 				; avanzo 2 pixeles
	sub r14, 4 				; dos pixeles menos que procesar
